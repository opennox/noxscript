...
var builtins = []*builtinDef{
	...
	asm.BuiltinRandomFloat:               {Name: "RandomFloat", Type: reflect.TypeOf(ns3.RandomFloat), Idemp: true},
	asm.BuiltinRandom:                    {Name: "Random", Type: reflect.TypeOf(ns3.Random), Idemp: true},
	...
	asm.BuiltinIsAttackedBy:              {Name: "IsAttackedBy", Type: reflect.TypeOf(ns3.IsAttackedBy), Idemp: true},
	...
	asm.BuiltinIsTrading:                 {Name: "IsTrading", Type: reflect.TypeOf(ns3.IsTrading), Idemp: true},
