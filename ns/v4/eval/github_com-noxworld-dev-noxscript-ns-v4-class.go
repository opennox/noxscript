// Code generated by 'yaegi extract github.com/opennox/noxscript/ns/v4/class'. DO NOT EDIT.
...
func init() {
	Symbols["github.com/opennox/noxscript/ns/v4/class/class"] = map[string]reflect.Value{
